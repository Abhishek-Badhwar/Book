...
import favbookImg from '../../assets/Books_images/fav_books.jpg';
    ...
    return (
        <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
            ...
            <div className='md:w-1/2'>
                ...
                <p className='mb-20 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis iusto tenetur modi blanditiis quas, rem cupiditate illum quaerat,
                    dolores illo nulla sequi adipisci porro ipsum esse quod culpa vero harum.</p>
